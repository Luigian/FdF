...
/*   Updated: 2019/09/09 16:34:57 by lusanche         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		calc_current_color_bonus(int percent, t_node *a, t_node *b, void **param)
{
	...
	return (colo->curr_red + colo->curr_green + colo->curr_blue);
}
...
void	draw_line(void **param, t_co *co, t_node *a, t_node *b)
{
	...
	while (1)
	{
		...
		if (map->on)
			color = map->color ? calc_current_color_bonus(percent, a, b, param) : calc_current_color_native(percent, a, b);
		else
			color = 0;
